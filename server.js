...
async function sendOtpEmail(email, code) {
  // Prefer an HTTPS email API on hosted services such as Render.
  // This avoids SMTP connection/port timeouts.
  ...
  // Keep SMTP as an optional fallback for local/other hosting.
